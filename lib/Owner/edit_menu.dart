...
class editMenu extends StatelessWidget {
  editMenu(this._shoppingItem, {Key? key}) {
    _controllerName = TextEditingController(text: _shoppingItem['FoodName']);
    _controllerQuantity =
        TextEditingController(text: _shoppingItem['FoodPrice']);

    _reference = FirebaseFirestore.instance
        .collection('Food')
        .doc(_shoppingItem['FoodID']);
  }
